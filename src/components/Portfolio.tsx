  ...
  const projects = [
    {
      ...
      specs: ["Madeira: MDF e Eucalipto", "Espaço dedicado para o fogão, garantindo praticidade no preparo das refeições", "Compartimento para micro-ondas, otimizado para facilitar o uso diário", "Design ergonômico que assegura conforto e fluidez na movimentação."]
    },
    {
